...
{
    public class Print_SellListInfoMap : EntityTypeConfiguration<Print_SellListInfo>
    {
        public Print_SellListInfoMap()
        {
            // Primary Key
            ...
            this.Property(t => t.系统单号)
                .HasMaxLength(50);

            // Table & Column Mappings
            this.ToTable("Print_SellListInfo");
            ...
            this.Property(t => t.系统单号).HasColumnName("系统单号");
        }
    }
}
