...
{
    public class Pro_BorowAduit_bakMap : EntityTypeConfiguration<Pro_BorowAduit_bak>
    {
        public Pro_BorowAduit_bakMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("Pro_BorowAduit_bak");
            ...
            this.HasOptional(t => t.Sys_UserInfo)
                .WithMany(t => t.Pro_BorowAduit_bak)
                .HasForeignKey(d => d.ApplyUser);
            this.HasOptional(t => t.Sys_UserInfo1)
                .WithMany(t => t.Pro_BorowAduit_bak1)
                .HasForeignKey(d => d.AduitUser);
            this.HasOptional(t => t.Pro_HallInfo)
                .WithMany(t => t.Pro_BorowAduit_bak)
                .HasForeignKey(d => d.HallID);
            this.HasOptional(t => t.Sys_UserInfo2)
                .WithMany(t => t.Pro_BorowAduit_bak2)
                .HasForeignKey(d => d.AduitUser2);
            this.HasOptional(t => t.Sys_UserInfo3)
                .WithMany(t => t.Pro_BorowAduit_bak3)
                .HasForeignKey(d => d.AduitUser3);
