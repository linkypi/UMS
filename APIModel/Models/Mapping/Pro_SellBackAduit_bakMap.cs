...
{
    public class Pro_SellBackAduit_bakMap : EntityTypeConfiguration<Pro_SellBackAduit_bak>
    {
        public Pro_SellBackAduit_bakMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("Pro_SellBackAduit_bak");
