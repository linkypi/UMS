...
{
    public class Pro_SellBackInfo_AduitMap : EntityTypeConfiguration<Pro_SellBackInfo_Aduit>
    {
        public Pro_SellBackInfo_AduitMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("Pro_SellBackInfo_Aduit");
            ...
            this.HasOptional(t => t.Pro_SellOffAduitInfo)
                .WithMany(t => t.Pro_SellBackInfo_Aduit)
            ...
            this.HasOptional(t => t.Sys_UserInfo1)
                .WithMany(t => t.Pro_SellBackInfo_Aduit1)
