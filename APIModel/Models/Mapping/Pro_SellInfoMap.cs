...
{
    public class Pro_SellInfoMap : EntityTypeConfiguration<Pro_SellInfo>
    {
        public Pro_SellInfoMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
