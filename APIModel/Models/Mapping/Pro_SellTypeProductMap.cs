...
{
    public class Pro_SellTypeProductMap : EntityTypeConfiguration<Pro_SellTypeProduct>
    {
        public Pro_SellTypeProductMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("Pro_SellTypeProduct");
            ...
            this.HasOptional(t => t.Pro_ProInfo)
                .WithMany(t => t.Pro_SellTypeProduct)
