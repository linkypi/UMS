...
{
    public class Pro_Sell_YanbaoMap : EntityTypeConfiguration<Pro_Sell_Yanbao>
    {
        public Pro_Sell_YanbaoMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
