...
{
    public class Report_BackListInfoMap : EntityTypeConfiguration<Report_BackListInfo>
    {
        public Report_BackListInfoMap()
        {
            // Primary Key
            this.HasKey(t => t.系统自增外键编号);
            ...
            this.ToTable("Report_BackListInfo");
            ...
            this.Property(t => t.自增外键退库编号).HasColumnName("自增外键退库编号");
