...
{
    public class Report_BorrowInfoMap : EntityTypeConfiguration<Report_BorrowInfo>
    {
        public Report_BorrowInfoMap()
        {
            // Primary Key
            this.HasKey(t => new { t.序号, t.系统自增主键 });
            ...
            this.ToTable("Report_BorrowInfo");
            this.Property(t => t.序号).HasColumnName("序号");
            this.Property(t => t.批次号).HasColumnName("批次号");
            this.Property(t => t.系统自增主键).HasColumnName("系统自增主键");
            this.Property(t => t.自增外键编号).HasColumnName("自增外键编号");
            ...
            this.Property(t => t.未还数量).HasColumnName("未还数量");
