...
{
    public class Report_ChangeIMEIInfoMap : EntityTypeConfiguration<Report_ChangeIMEIInfo>
    {
        public Report_ChangeIMEIInfoMap()
        {
            // Primary Key
            ...
            this.ToTable("Report_ChangeIMEIInfo");
            ...
            this.Property(t => t.自增外键转类别单编号).HasColumnName("自增外键转类别单编号");
