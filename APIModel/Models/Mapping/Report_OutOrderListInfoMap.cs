...
{
    public class Report_OutOrderListInfoMap : EntityTypeConfiguration<Report_OutOrderListInfo>
    {
        public Report_OutOrderListInfoMap()
        {
            // Primary Key
            this.HasKey(t => new { t.序号, t.批次号, t.数量, t.已接收 });
            ...
            this.ToTable("Report_OutOrderListInfo");
