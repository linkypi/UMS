...
{
    public class Report_ReturnIMEIInfoMap : EntityTypeConfiguration<Report_ReturnIMEIInfo>
    {
        public Report_ReturnIMEIInfoMap()
        {
            // Primary Key
            this.HasKey(t => new { t.序号, t.自主主键编号, t.归还明细外键编号, t.归还外键编号, t.数量 });

            // Properties
            this.Property(t => t.序号)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.自主主键编号)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.归还明细外键编号)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.归还外键编号)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.ToTable("Report_ReturnIMEIInfo");
            this.Property(t => t.序号).HasColumnName("序号");
            this.Property(t => t.自主主键编号).HasColumnName("自主主键编号");
            this.Property(t => t.归还明细外键编号).HasColumnName("归还明细外键编号");
            this.Property(t => t.归还外键编号).HasColumnName("归还外键编号");
