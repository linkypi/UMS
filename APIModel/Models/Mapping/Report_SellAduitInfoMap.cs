...
{
    public class Report_SellAduitInfoMap : EntityTypeConfiguration<Report_SellAduitInfo>
    {
        public Report_SellAduitInfoMap()
        {
            // Primary Key
