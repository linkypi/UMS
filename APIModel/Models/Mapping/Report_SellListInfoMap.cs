...
{
    public class Report_SellListInfoMap : EntityTypeConfiguration<Report_SellListInfo>
    {
        public Report_SellListInfoMap()
        {
            // Primary Key
            ...
            this.Property(t => t.仓属性)
                .HasMaxLength(50);

            // Table & Column Mappings
            this.ToTable("Report_SellListInfo");
            ...
            this.Property(t => t.仓属性).HasColumnName("仓属性");
        }
    }
}
