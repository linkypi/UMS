...
{
    public class Report_VipBuyTimeInfo2Map : EntityTypeConfiguration<Report_VipBuyTimeInfo2>
    {
        public Report_VipBuyTimeInfo2Map()
        {
            // Primary Key
            ...
            this.ToTable("Report_VipBuyTimeInfo2");
