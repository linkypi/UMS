...
{
    public class VIP_RenewBackAduit_bakMap : EntityTypeConfiguration<VIP_RenewBackAduit_bak>
    {
        public VIP_RenewBackAduit_bakMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("VIP_RenewBackAduit_bak");
