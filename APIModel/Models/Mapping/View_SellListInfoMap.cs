...
{
    public class View_SellListInfoMap : EntityTypeConfiguration<View_SellListInfo>
    {
        public View_SellListInfoMap()
        {
            // Primary Key
            this.HasKey(t => t.SepecialOffName);
            ...
            this.ToTable("View_SellListInfo");
