...
{
    public class View_SellOffAduitInfo2Map : EntityTypeConfiguration<View_SellOffAduitInfo2>
    {
        public View_SellOffAduitInfo2Map()
        {
            // Primary Key
            ...
            this.ToTable("View_SellOffAduitInfo2");
