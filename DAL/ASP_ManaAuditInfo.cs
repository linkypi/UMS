...
namespace DAL
{
    public class ASP_ManaAuditInfo
    {
         private int MethodID;

        public ASP_ManaAuditInfo()
        {
            this.MethodID = 0;
        }

        public ASP_ManaAuditInfo(int MenthodID)
        {
        ...
        public Model.WebReturn Search(Model.Sys_UserInfo user, Model.ReportPagingParam pageParam)
        {
            using (LinQSqlHelper lqh = new LinQSqlHelper())
            {
                try
                {
                    ...
                    var aduit_query = from b in lqh.Umsdb.View_ASPSHInfo
                                      select b;
                    ...
                    if (pageParam.PageIndex > pagecount)
                    {
                        ...
                        List<Model.View_ASPSHInfo> aduitList = results.ToList();
