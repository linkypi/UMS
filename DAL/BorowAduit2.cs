...
namespace DAL
{
    ...
    public class BorowAduit2
    {
        ...
        public BorowAduit2(int MenthodID)
        {
                ...
                using (TransactionScope ts = new TransactionScope())
                {
                    try
                    {
                        ...
                        foreach (var item in models)
                        {
                            ...
                            {
                                return new Model.WebReturn() { ReturnValue = false, Message = "审批单 " + aduitModel.AduitID + " 未进行一级审批，审批失败！" };
                            }
                            ...
                            aduitModel.AduitDate2 = item.AduitDate2;
                            aduitModel.AduitUser2 = item.AduitUser2;
                            aduitModel.Aduited2 = item.Aduited2;
                            ...
                            if (item.Passed2 != true)
                            {
                                ...
                                aduitModel.Passed = item.Passed2;
        ...
        public Model.WebReturn Search(Model.Sys_UserInfo user, Model.ReportPagingParam pageParam)
        {
            using (LinQSqlHelper lqh = new LinQSqlHelper())
            {
                try
                {
                    ...
                    var aduit_query = from b in lqh.Umsdb.View_BorowAduit2
                    ...
                    if (pageParam.PageIndex > pagecount)
                    {
                        ...
                        List<Model.View_BorowAduit2> aduitList  = results.ToList();
