...
namespace DAL
{
    public class Report_Return
    {

          public string ReportViewName = "Report_Return";
          public IQueryable<ReportModel.Report_Return> GetList(Model.Sys_UserInfo user, ReportModel.Entities ObjectContext)
          {
              using (LinQSqlHelper lqh = new LinQSqlHelper())
              {
                  ...
                  try
                  {
                      ...
                      { return new List<ReportModel.Report_Return>().AsQueryable(); }
                      ...
                      var objSet = ObjectContext.Report_Return.AsQueryable();
                      ...
                      objSet = from b in objSet
                               ...
                               select b;
                      #endregion
                      return objSet.OrderBy(p => p.归还日期);
