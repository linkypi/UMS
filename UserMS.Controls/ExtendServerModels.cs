...
namespace UserMS.API
{
    ...
    public partial class View_OutIMEI
    {
        public TimeSpan AreaAge
        {
            get {
                if (this.AreaAgeInitDate == null)
                { return new TimeSpan(); }
              return (TimeSpan)(DateTime.Now - this.AreaAgeInitDate -
                    (this.AreaAgeDelta - new DateTime(2000, 1, 1)));
            }
        }
    }
