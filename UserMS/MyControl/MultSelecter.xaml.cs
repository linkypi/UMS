...
namespace UserMS
{
    public partial class MultSelecter
    {
        ...
        public MultSelecter(List<TreeViewModel> LeftTree, IEnumerable Items, string ForeignKey, string FilterKey, string[] GridColumn, string[] GridTitle)
        {
            InitializeComponent();
        ...
        public MultSelecter(List<TreeViewModel> LeftTree, IEnumerable Items, string ForeignKey, string FilterKey, string[] GridColumn, string[] GridTitle, bool New)
        {
            InitializeComponent();
            this.Owner = Application.Current.MainWindow;
            this.Height = 422;
