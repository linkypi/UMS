...
namespace UserMS
{
    public partial class MultSelecter2:RadWindow
    {
        ...
        /// <param name="FilterKey">筛选框筛选的键 只能为string类型</param>
        /// <param name="GridColumn">GridView的列</param>
        /// <param name="GridTitle">GridView的标题</param>
        public MultSelecter2(List<TreeViewModel> LeftTree, IEnumerable Items,  string FilterKey, string[] GridColumn, string[] GridTitle)
        {
            InitializeComponent();
