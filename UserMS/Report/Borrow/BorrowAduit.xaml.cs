...
namespace UserMS.Report.Borrow
{
    /// <summary>
    /// PrintOutOrder.xaml 的交互逻辑
    /// </summary>
    public partial class BorrowAduit : BasePage
    {
        private int PageSize = 20;
        public string ReportName = "Report_BorrowAduitInfo";
        ...
        private void BasePage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                this.datasource.Expand = "Report_BorrowAduitListInfo";
        ...
        private void Export_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            //this.datasource.Load();
            var query = a.CreateQuery<ReportService.Report_BorrowAduitInfo>(this.ReportName).Where(this.datasource.FilterDescriptors);
            ...
            Thread oThread = new Thread(delegate()
            {
                ...
                try
                {
                    var list = (List<ReportService.Report_BorrowAduitInfo>)query.ToIList();
                    ...
                    if (dialog.ShowDialog() == true)
                    {
                        using (Stream stream = dialog.OpenFile())
                        {
                            ...
                            var x = new SlModel.operateExcel<ReportService.Report_BorrowAduitInfo>();
        ...
        private void Grid_SelectionChanged(object sender, SelectionChangeEventArgs e)
        {
            ...
            if (this.Grid.SelectedItems.Count == 0)
                ...
                this.GridList.ItemsSource = ((ReportService.Report_BorrowAduitInfo)this.Grid.SelectedItems[0]).Report_BorrowAduitListInfo;
