...
namespace UserMS.Report.InOutSell
{
    public partial class GridReportInOutSell : BasePage
    {
        ...
        public GridReportInOutSell()
        {
            ...
            this.BeginTime.SelectionChanged +=BeginTime_SelectionChanged;
            this.EndTime.SelectionChanged += BeginTime_SelectionChanged; 
        }
        ...
        private void datasource_LoadingData(object sender, LoadingDataEventArgs e)
        {
                ...
                e.Query = ((System.Data.Services.Client.DataServiceQuery<UserMS.ReportService.Report_InOutSellInfo>)e.Query).AddQueryOption(
                   "BeginTime", this.BeginTime.SelectedValue).AddQueryOption(
                   "EndTime", this.EndTime.SelectedValue);
                if (q != null && e.Query.RequestUri.AbsoluteUri == q.RequestUri.AbsoluteUri) e.Cancel = true;
                q = e.Query;
        }
        ...
        private void datasource_LoadedData(IAsyncResult result)
        {
                ...
                Application.Current.Dispatcher.Invoke((Action)delegate
                {
                    try
                    {
                        ...
                        var list = (List<ReportService.Report_InOutSellInfo>)query.EndExecute(result).AsQueryable().Where(this.datasource.FilterDescriptors).ToIList();
