...
namespace UserMS.Report.Print
{
    ...
    /// </summary>
    public partial class PrintOutOrder : BasePage
    {
        private int PageSize = 20;
        private string ReportName = "Report_OutOrderListInfo";
        public PrintOutOrder()
        {
            InitializeComponent();
        ...
        private void BasePage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                reportDataSource.Name = "OutOrderDataSet"; // Name of the DataSet we set in .rdlc

                _reportViewer.LocalReport.DisplayName = "调拨单";
                _reportViewer.LocalReport.ReportPath = "Report\\Print\\transfer.rdlc"; // Path of the rdlc file
        ...
        private void Grid_SelectionChanged(object sender, SelectionChangeEventArgs e)
        {
            ...
            reportDataSource.Value = this.Grid.SelectedItems;
