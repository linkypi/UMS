...
{
    public partial class ProfitReport : Page
    {
        public ProfitReport()
        {
            InitializeComponent();
...
//            
            ...
            this.datasource.QueryName = "Report_Profit";
            ...
            _reportViewer.LocalReport.ReportPath = "Report\\ProfitReport.rdlc"; // Path of the rdlc file
