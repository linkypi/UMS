...
{
    public partial class Zhuanxiang3 : Page
    {
        public DateTime v;
        public Zhuanxiang3()
        {
...
//            
            ...
            this.datasource.QueryName = "Report_VipBuyTimeInfo2";
            ...
            _reportViewer.LocalReport.ReportPath = "Report\\Zhuanxiang3.rdlc"; // Path of the rdlc file
...
//            }
        ...
        private void ButtonBase_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            FilterDescriptor f1 = new FilterDescriptor("注册时间", FilterOperator.IsGreaterThanOrEqualTo, FirstDay);
            cfd.FilterDescriptors.Add(f1);
            FilterDescriptor f2 = new FilterDescriptor("注册时间", FilterOperator.IsLessThan, LastDay.Value.AddDays(1));
