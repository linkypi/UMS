...
{
    /// <summary>
    /// PriceBillReport.xaml 的交互逻辑
    /// </summary>
    public partial class PriceBillReport : Page
    {
        private List<API.View_PriceBillReport> models = null;
        private int pageindex = 0;
        private bool flag = false;


        public PriceBillReport()
        {
            InitializeComponent();

            this.SizeChanged += PriceBillReport_SizeChanged;
            models = new List<API.View_PriceBillReport>();
        ...
        void PriceBillReport_SizeChanged(object sender, SizeChangedEventArgs e)
        {
        ...
        {
            if (!flag) { return; }
            PublicRequestHelp prh = new PublicRequestHelp(this.busy, 186, new object[] { page.PageIndex, (int)pagesize.Value }, new EventHandler<API.MainCompletedEventArgs>(GetCompleted));
        ...
        private void GetCompleted(object sender, API.MainCompletedEventArgs e)
        {
            ...
            {
                models.Clear();
                List<API.View_PriceBillReport> list = e.Result.Obj as List<API.View_PriceBillReport>;
