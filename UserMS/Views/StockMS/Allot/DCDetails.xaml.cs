...
{
    public partial class DCDetails : BasePage
    {
  
        public int MethodID = 24;
        ...
        public DCDetails()
        {
            ...
            this.StartTime.SelectedValue = DateTime.Now.Date;
            TimeSpan span = new TimeSpan(23, 59, 59);
            this.EndTime.SelectedValue = DateTime.Today.Add(span);
            //  this.ClassName.SearchButton.Click += SearchButton_Click;
            //  AddParameter = new SearchParameter(ref ClassName);
            #region 添加参数事件
            //添加搜索参数
        ...
        void Search()
        {
            ...
            //{
            //  //  MessageBox.Show(System.Windows.Application.Current.MainWindow,"请选择调出仓库！");
            //    return;
            //}
        ...
        void Cancle()
        {
            ...
            //}
            PublicRequestHelp help = new PublicRequestHelp(this.busy,MethodIDStore.Method_Cancel, new object[] { model }, BackResult);
        }
