...
namespace UserMS.Views.StockMS.Borrowing.Aduit
{
    ...
    /// 一级审批--区域
    /// </summary>
    public partial class BorowAduit : Page
    {
        ...
        private void btnDelete_Click(object sender, RoutedEventArgs e)
        {
            ...
            API.View_BorowAduit vb = GridAuitList.SelectedItem as API.View_BorowAduit;
        ...
        private void aduitPassed_Click(object sender, RoutedEventArgs e)
        {
            ...
            API.View_BorowAduit aduit = GridAuitList.SelectedItem as API.View_BorowAduit;

            if (aduit.HasAduited1 == true)
            {
            ...
            PublicRequestHelp prh = new PublicRequestHelp(this.isbusy, 21, new object[] { mList }, new EventHandler<API.MainCompletedEventArgs>(AduitCompeleted));
        ...
        private void Aduit(bool flag)
        {
            ...
            {
                API.View_BorowAduit aduit = item as API.View_BorowAduit;
            ...
            foreach (var item in GridAuitList.SelectedItems)
            {
                API.View_BorowAduit vb = item as API.View_BorowAduit;
                ba = new API.Pro_BorowAduit();
                ba.ID = vb.ID;
                ba.AduitDate = DateTime.Now;
                ba.AduitUser = Store.LoginUserInfo.UserID;
        ...
        private void Search()
        {
            ...
            PublicRequestHelp prh = new PublicRequestHelp(this.isbusy, 67, new object[] { rpp }, new EventHandler<API.MainCompletedEventArgs>(SearchCompleted));
        }
        ...
        private void GridApplyList_SelectionChanged(object sender, SelectionChangeEventArgs e)
        {
