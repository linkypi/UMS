...
{
    /// <summary>
    /// RepairStockIn.xaml 的交互逻辑
    /// </summary>
    public partial class RepairStockIn : Page
    {
        //public RepairStockIn()
        //{
        //    InitializeComponent();
        //}
        ...
        private void GetFristHall()
        {
            ...
            hall = filter.FilterHall(int.Parse(menuid), HallInfo);
            if (hall == null)
            {
                return;
            }
        ...
        private void Sumbit_Click(object sender, RoutedEventArgs e)
        {
            ...
            List<int> cls = new List<int>() { 128,129,131};
            ...
            foreach (var vm in vmodels)
            {
                ...
                int kla = Convert.ToInt32( Store.ProInfo.Where(p => p.ProID == vm.ProID).First().Pro_ClassID);
                if (cls.Contains(kla) == false)
                {
                    System.Windows.MessageBox.Show(vm.ProName+"不属于售后维修产品！");
                    return;
                }
                //if (vm.Price == 0)
                //{
            ...
            PublicRequestHelp help = new PublicRequestHelp(this.PageBusy, 384, new object[] { inorder }, SubmitCompleted);
        ...
        private void SubmitCompleted(object sender, API.MainCompletedEventArgs mcea)
        {
            ...
            if (mcea.Error == null)
            {
                ...
                else
                {
                    ...
                    print.SrcPage = "/Views/StockMS/EnteringStock/RepairStockIn.xaml?MenuID=366";
        ...
        private void Add_Click_1(object sender, Telerik.Windows.RadRoutedEventArgs e)
        {
            ...
            try
            {
                ...
                AddPro.ProFilter(AddPro.GetPro(int.Parse(menuid.Trim())), true);
